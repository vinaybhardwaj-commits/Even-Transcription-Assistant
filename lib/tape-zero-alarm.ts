 ...
 *     chunks from 9 Sep to 21 Sep 15:51 IST (several app releases, INCLUDING the current 0.1.24: Cardiology OPD, on 0.1.24 since its 17 Sep 15:41 IST update, made 137 of them 19-21 Sep, eta-refuter #2206; the last exact-zero chunk on record is 21 Sep 15:51 IST), but a release that changed the bitrate, frame size or container would move it and the alarm would go silently BLIND (a "field stopped arriving" failure).
